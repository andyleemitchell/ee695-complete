...
class CounterPicker():
        ...
        while not rospy.is_shutdown():
            ...
            while True:
                ...
                if success in ["p", "P", "f", "F"]:
                    ...
                    print("[2]: counter fell short of board")
                    print("[3]: counter fell long of board")
                    print("[4]: counter bounced out of slot")
                    print("[5]: went to wrong slot")
            ...
            if self.counter >= self.num_picks:
                ...
                with open(self.results_dir+"/place_test_results_"+str(self.num_picks)+"_"+time.strftime("%Y%m%d-%H%M%S")+".json", "w") as f:
    ...
    def drop_pose(self):
        ...
        pose_goal.pose.position.x = 0.226
